...
/*
    ...
    # СЛОЖНОЕ ЗАДАНИЕ: Реализуйте свой собственный класс MyList<T>, который будет работать 
        как упрощенная версия List<T>. Он должен иметь:
        - Внутренний массив для хранения данных
        - Методы Add, Remove, Contains, IndexOf
