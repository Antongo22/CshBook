...
/* Задачи:
    ...
    6. Напишите метод, который работает с `Dictionary` и ловит `KeyNotFoundException`.
    7. Сделайте метод, который считывает содержимое файла, а в `finally` закрывает поток.
    8. Сделайте программу-калькулятор, в которой все операции защищены `try-catch`, чтобы не было аварийного завершения.
*/
