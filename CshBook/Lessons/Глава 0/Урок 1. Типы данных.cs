    ...
    */
    ...
    internal static class FirstLesson // Урок 1. Типы данных
    {
        public static void Main_()
        {
            ...
            int_1++; // Прибавляет к числу 1. Постфикс
            int_1--; // Уменьшает число на 1. Постфикс
            ++int_1; // Прибавляет к числу 1. Префикс
            --int_1; // Уменьшает число на 1. Префикс

            /*
             В чем разница между префиксом и постфиксом инкремента?
                1. Префиксный инкремент (также и декремент) вычитывает значение и сразу же возвращает уже "новое", только что высчитанное.
                2. Постфиксный инкремент (также и декремент) сначала выдает "старое" значение, а "новое" высчитывает уже после окончания инструкции.
             */
            ...
            // Так же есть знаки: < (меньше), > (больше), <= (меньше или равно), >= (больше или равно) 
