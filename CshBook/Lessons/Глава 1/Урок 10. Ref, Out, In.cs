...
namespace CshBook.Lessons
{
    ...
    */
    ...
    Это полезно для передачи больших структур данных без копирования, но с гарантией, что ссылка не будут изменена.

    public static void ReadArrayWithIn(in int[] array)
    {
        Console.WriteLine(array[0]); // Только читаем элемент массива
        // array[0] = 100; // ! Так можно!
        // array = new int[] { 10, 20, 30 }; // так нет!
    }
     */
    ...
    internal static class TenthLesson
    {
        ...
        {
            Console.WriteLine(array[0]); // Только читаем элемент массива
            // array[0] = 100; // ! Так можно! Но это не повлияет на исходный массив
            // array = new int[] { 10, 20, 30 }; // так нет!
        }
...
5. Обнуление массива:
   Напишите функцию, которая принимает массив и обнуляет все его элементы.
*/
